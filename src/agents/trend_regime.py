...
PERSONA_BACKSTORY = "Helios traded systematic trend strategies and now weighs deterministic momentum features before advising the desk."
...
def trend_regime_agent(state: AgentState, agent_id: str = "trend_regime_agent"):
    ...
    for ticker in tickers:
        ...
        bullish_stack = recent_close > recent_mid > recent_long and slope_mid >= -0.005 and slope_long >= -0.002 and momentum_factor >= -0.05
        bearish_stack = recent_close < recent_mid < recent_long and slope_mid <= 0.005 and slope_long <= 0.002 and momentum_factor <= 0.05
...
async def trend_regime_agent_async(state: AgentState, agent_id: str = "trend_regime_agent"):
    """Async version of trend regime analyst."""
